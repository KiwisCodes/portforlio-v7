...
export const EDUCATION_DATA: EducationItem[] = [
  {
    ...
    achievements: [
      { icon: "🏅", text: "DAAD Study & Stay 2025", isFeatured: true },
      { icon: "🏅", text: "DAAD Sur-place Scholarship" },
  ...
  },
  {
    ...
    achievements: [{ icon: "🌍", text: "Study as a DAAD Scholar" }],
  },
  {
    id: 3,
    ...
    achievements: [{ icon: "🥉", text: "Third Prize - City Math Competition" }],
  },
];
