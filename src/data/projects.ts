...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'Led a 5-person team to build a high-performance traffic simulation engine with Java 17 and TraCI.',
    details: [
    ...
    image: 'https://images.unsplash.com/photo-1510001099195-2eb4cb8bdac6?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    description: 'A complete serverless booking system built with React and Google Apps Script backend.',
    details: [
    ...
    image: 'https://images.unsplash.com/photo-1492666673288-3c4b4576ad9a?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    description: 'Smart travel itinerary generator powered by Gemini 1.5 Flash.',
    details: [
